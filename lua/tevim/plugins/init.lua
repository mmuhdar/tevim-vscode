local plugins = {
	...
	},
	{
		...
		keys = {
			{ mode = "n", "<C-_>", "<Plug>(comment_toggle_linewise_current)",      desc = "Toggle Comment" },
			{ mode = "i", "<C-_>", "<esc><Plug>(comment_toggle_linewise_current)", desc = "Toggle Comment(Insert)" },
			{ mode = "v", "<C-_>", "<Plug>(comment_toggle_linewise_visual)",       desc = "Toggle Comment(Visual)" },
	},	
